...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { day: @weather.day, maxTemp: @weather.maxTemp, minTemp: @weather.minTemp, month: @weather.month, solstice: @weather.solstice, year: @weather.year } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { day: @weather.day, maxTemp: @weather.maxTemp, minTemp: @weather.minTemp, month: @weather.month, solstice: @weather.solstice, year: @weather.year } }
